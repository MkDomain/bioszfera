<?php
$sectiontag = '<section class="section section-md context-dark bg-image text-center" id="services" data-type="anchor" style="background-image: url(images2//Esoerdo.jpg)">';
...
<html class="wide wow-animation" lang="hu">
  <head>
    <title>Bioszféra - Vélemények</title>
